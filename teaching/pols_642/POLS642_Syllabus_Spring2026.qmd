...
[Tuesday](W1L1_Intro.qmd) `r advdate(tue, 1)`
...
Thursday `r advdate(thu, 3)`
  ...
  - Data Camp: "Foundations of Probability in R" and "Hypothesis Testing in R" (DUE Friday `r advdate(fri, 3)` by 5PM)
...
Thursday `r advdate(thu, 4)`
   ...
   - Data Camp: "Introduction to Regression in R" (DUE Friday `r advdate(fri, 4)` by 5PM)
...
Thursday `r advdate(thu, 5)`
   ...
   - Data Camp: "Intermediate Regression in R" (DUE Friday `r advdate(fri, 5)` by 5PM)
...
Tuesday `r advdate(tue, 10)`

  - Review Weeks 1-4

Thursday `r advdate(thu, 10)`
  
  - Review Weeks 5-7

## Week 11: Causality

Tuesday `r advdate(tue, 11)`

  - Midterm Exam Re-Take

Thursday `r advdate(thu, 11)`
 
   - Heiss, ["Causal Inference"](https://www.andrewheiss.com/research/chapters/heiss-causal-inference-2021/10-causal-inference.pdf)
   - Optional: *The Effect* [Chapters 5-8](https://theeffectbook.net/ch-Identification.html)
  
## Week 12: Experiments

Tuesday `r advdate(tue, 12)`

  - *Real Stats* Chapter 10 or *QSS* Chapter 2
  
Thursday `r advdate(thu, 12)` 

  - *The Effect* [Chapters 9-10](https://theeffectbook.net/ch-FindingFrontDoors.html)

  - PROBLEM SET #2 (DUE Friday `r advdate(fri, 12)` by 5PM)
  
## Week 13: Matching and Mixed Methods

Tuesday `r advdate(tue, 13)`: Matching

   - *The Effect* [Chapter 14](https://theeffectbook.net/ch-Matching.html)

Thursday `r advdate(thu, 13)`: Mixed Methods Research

  - Lieberman, "Nested Analysis"
  - Seawright and Gerring, "Case Selection Techniques in Case Study Research"
  
## Week 14: Fixed Effects  

Tuesday `r advdate(tue, 14)`

  - *The Effect* [Chapter 16 - 16.2.1](https://theeffectbook.net/ch-FixedEffects.html)
  - Optional: *Real Stats* Chapter 8
  
Thursday `r advdate(thu, 14)`  

  - *The Effect* [Chapter 16.2.2-16.3](https://theeffectbook.net/ch-FixedEffects.html#multiple-sets-of-fixed-effects)
  - Optional: *Real Stats* Chapter 15

 - PROBLEM SET #3 (DUE Friday `r advdate(fri, 14)` by 5PM)

 
## Week 15: Diff-in-Diff and Instrumental Variables

Tuesday `r advdate(tue, 15)`

- *The Effect* [Chapter 17](https://theeffectbook.net/ch-EventStudies.html)

Thursday `r advdate(thu, 15)`  
