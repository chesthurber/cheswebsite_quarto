...
Tuesday `r advdate(tue, 10)`
  ...
  - Review Weeks 1-4
  - Check out *ROS* Chapters 4 and 6

Thursday `r advdate(thu, 10)`
  
  - Review Weeks 5-7
  - Check out *ROS* Assumptions and Kuehl and Thurber's Assumptions sheet
...
Tuesday `r advdate(tue, 12)`
  ...
  - Optional review: *Real Stats* Chapter 10 or *QSS* Chapter 2
  - *ROS* Experiments
